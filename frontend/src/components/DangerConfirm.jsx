         ...
         <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
               <div className="relative transform overflow-hidden bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                  <div className="bg-white dark:bg-darkmodeSecondary px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                     <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                           <h3 className="text-base font-semibold leading-6 text-gray-900 dark:text-gray-400" id="modal-title">
                              {props.title ? props.title : "Deactivate account"}
                           </h3>
                           <div className="mt-2">
                  ...
                  <div className="bg-white dark:bg-darkmodeSecondary px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                     {props.children}
                     {/* BUTTON NEEDED AT LEAST 1 BUTTON CONFIRM */}
                     {/* <button
                        type="button"
