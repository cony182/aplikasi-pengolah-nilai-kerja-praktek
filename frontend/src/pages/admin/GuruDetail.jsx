...
const GuruDetail = () => {
   ...
   useEffect(() => {
      axios
         .get("/admin/teachers/" + nip, { withCredentials: true })
         .then((response) => {
            setGuru(response.data.guru);
            setMapelid(response.data.guru.mapelId);
   ...
   const update = (id) => {
      axios
         .post("/admin/teachers", { mapelid: mapelid, id: id }, { withCredentials: true })
         .then((response) => {
            setOnSuccess(true);
            setTimeout(() => {
               setOnSuccess(false);
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
               ...
               <li aria-current="page">
                  <div className="flex items-center">
                     ...
                     <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{guru.nama}</span>
                  </div>
               </li>
            </ol>
         </nav>
               ...
               <div className="md:px-6">
                  <div className="flex flex-wrap justify-center">
                     <div className="w-full px-4 h-2 -translate-y-12 flex justify-center lg:justify-start">
                        <div className="h-36 relative">
                           <img
                              src={guru.user ? `${axios.defaults.baseURL}/images/avatar/${guru.user.picture}` : Image}
                              alt=""
                  ...
                  <div className="text-center lg:text-start mt-28 lg:ml-4 lg:mt-0">
                     <div className="lg:ml-40">
                        <h3 className="text-xl font-semibold leading-normal text-gray-500 dark:text-gray-400 mb-2">{guru.nama}</h3>
                        <div className="text-sm leading-normal mt-0 mb-2 text-gray-500 dark:text-gray-400 font-bold">{guru.NIP}</div>
                     </div>
                  </div>
                                 ...
                                 <dl className="sm:divide-y sm:divide-gray-200 dark:sm:divide-gray-500 text-left">
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       ...
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">
                                          {guru.userId ? guru.userId : <div className="opacity-50">kosong</div>}
                                       </dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Nama</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">{guru.nama}</dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">NIP</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">{guru.NIP}</dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">HP</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">
                                          {guru.telp ? guru.telp : <div className="opacity-50">kosong</div>}
                                       </dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Alamat</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">
                                          {guru.alamat ? guru.alamat : <div className="opacity-50">kosong</div>}
                                       </dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Tgl lahir</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">
                                          {guru.tgl_lahir ? guru.tgl_lahir : <div className="opacity-50">kosong</div>}
                                       </dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Tempat lahir</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">
                                          {guru.tmpt_lahir ? guru.tmpt_lahir : <div className="opacity-50">kosong</div>}
                                       </dd>
                                    </div>
                                    <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                       <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Dibuat pada</dt>
                                       <dd className="mt-1 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:col-span-2">
                                          {new Date(guru.createdAt).toLocaleString("en-US", {
                                             year: "numeric",
                                             month: "2-digit",
                                             day: "2-digit",
                                             hour: "2-digit",
                                    ...
                                    {guru.mapelId ? (
                                       <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                          <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Mapel</dt>
