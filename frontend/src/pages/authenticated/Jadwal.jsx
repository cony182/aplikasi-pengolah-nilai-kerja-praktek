...
function Dashboard() {
   ...
   useEffect(() => {
      axios
         .get("http://192.168.100.2:5000/" + role + "/jadwal", {
            withCredentials: true,
         })
         .then((response) => {
            console.log(response.data);
            setMapel(response.data[0]);
            setIsGuru(response.data[1] == "guru" ? true : false);
            setLoading(false);
         })
         .catch((err) => {
            ...
            <>
               <div className="pt-10">
                  ...
                  <div className="flex flex-wrap">
                     ...
                     {/* <div className="max-w-sm rounded overflow-hidden shadow-lg mx-auto sm:mx-0 sm:ml-3 my-3 bg-white dark:bg-darkmode">
                        <div className="px-6 py-4">
                           <div className="font-bold text-xl mb-2 dark:text-gray-300">Fisika</div>
                           <p className="text-gray-700 text-base dark:text-gray-500">Sade</p>
                        </div>
                        <div className="px-6 pb-2">
                           <span className="inline-block bg-gray-200 dark:bg-gray-400 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                              Kamis
