...
const Index = () => {
   ...
   useEffect(() => {
      axios
         .get("http://192.168.100.2:5000/cookie", { withCredentials: true })
         .then((response) => {
   ...
   return loading ? (
      ...
      <>
                  ...
                  <div className="flex items-center justify-between py-4">
                     ...
                     <div className="hidden sm:flex sm:items-center">
                        {hasLogin ? (
                           ...
                           <Link to="/login">
                              <span className="text-gray-800 text-sm font-semibold transition duration-300 hover:text-purple-600 mr-4">Login</span>
                           </Link>
                        )}
                        {hasLogin ? (
                           ""
         ...
         <Link to={hasLogin ? "/home" : "/login"}>
            <div>{hasLogin ? "Home" : "Login"}</div>
         </Link>
      </>
   );
};
